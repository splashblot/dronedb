  ...
  module Api
    class DataImportPresenter
      ...
      HTTP_RESPONSE_CODE_MESSAGES = {
        ...
        "400" => "This usually means Agroviz did not perform the request properly.",
        "401" => "This usually means Agroviz is not authorized to retrieve this file. If you have authorization, " \
                  "download the file manually and upload it from your computer.",
        "402" => "This usually means Agroviz is not authorized to retrieve this file. If you have authorization, " \
                  "download the file manually and upload it from your computer.",
        "403" => "This usually means Agroviz is not authorized to retrieve this file. If you have authorization, " \
        ...
        "405" => "This usually means Agroviz could not negotiate the download with the file's provider. The " \
                  "provider is probably using a non standard method to serve this file.",
        "407" => "This usually means Agroviz is not authorized to retrieve this file as proxy authentication " \
        ...
        "411" => "This usually means Agroviz did not perform the request properly. 'Content Length' header is missing.",
        "412" => "This usually means Agroviz could not negotiate the download with the file's provider. The " \
                  "provider is probably using a non standard method to serve this file.",
        "413" => "This usually means the file provider is denying the download because the file is too large.",
        "417" => "This usually means Agroviz could not negotiate the download with the file's provider. The " \
                  "provider is probably using a non standard method to serve this file.",
        ...
        "501" => "This usually means Agroviz could not negotiate the download with the file's provider. The " \
                  "provider is probably using a non standard method to serve this file.",
        ...
        "511" => "This usually means Agroviz is not authorized to retrieve this file. If you have " \
