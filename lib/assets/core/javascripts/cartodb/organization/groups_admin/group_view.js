  ...
  render: function () {
    ...
    this.$el.html(
      this.getTemplate('organization/groups_admin/group')({
        ...
        sharedMapsCount: pluralizeStr('1 mapa compartido', sharedMapsCount + ' mapas compartidos', sharedMapsCount),
        sharedDatasetsCount: pluralizeStr('1 dataset compartido', sharedDatasetsCount + ' datasets compartidos', sharedDatasetsCount),
