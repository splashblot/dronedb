  ...
  render: function () {
    ...
    var pagedSearchView = new PagedSearchView({
      ...
      noResults: {
        ...
        title: 'Aún no has creado ningún grupo',
        msg: 'Crear grupos te ayuda a visualizar y buscar usuarios asignados a un grupo de trabajo o un equipo dentro de la organización.'
      }
    });
