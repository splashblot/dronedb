...
module.exports = Router.extend({
  ...
  routes: {
    ...
    // Devices/drones
    'drones':                                 '_changeRouteToDrones',
    'drones/':                                '_changeRouteToDrones',
    'drones?:q':                              '_changeRouteToDrones',
    'drones/:page':                           '_changeRouteToDrones',
    'drones/:page?:q':                        '_changeRouteToDrones',
    'devices':                                '_changeRouteToDevices',
    'devices/':                               '_changeRouteToDevices',
    'devices?:q':                             '_changeRouteToDevices',
    'devices/:page':                          '_changeRouteToDevices',
    'devices/:page?:q':                       '_changeRouteToDevices',
  ...
  _changeRouteToDrones: function(page) {
    page = this._getPage(page);
    var shared = this._doesCurrentUrlContain('drones/shared');
    var locked = this._doesCurrentUrlContain('drones/locked') || this._doesCurrentUrlContain('shared/locked');
    var liked = this._doesCurrentUrlContain('drones/liked');
  ...
  _changeRouteToDevices: function(page) {
    page = this._getPage(page);
    var shared = this._doesCurrentUrlContain('devices/shared');
    var locked = this._doesCurrentUrlContain('devices/locked') || this._doesCurrentUrlContain('shared/locked');
    var liked = this._doesCurrentUrlContain('devices/liked');
