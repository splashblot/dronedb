...
cdb.admin.MapTab = cdb.core.View.extend({
  ...
  setBaselayerVis: function() {
    ...
    var makeVis = function() {
      ...
      L.tileLayer('https://alpha.tileo.co/data/odm/lechugas_tiling/{z}/{x}/{y}.png').addTo(map);
          ...
          "layers": [
              {
                  "type": "cartodb",
                  "options": {
                      "sql": `SELECT * FROM lechugaslines union all select * from lechugaspoints`,
                      "cartocss": `#lechugaspoints{
