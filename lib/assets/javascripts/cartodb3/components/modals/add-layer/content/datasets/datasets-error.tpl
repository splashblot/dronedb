<div class="IntermediateInfo">
  ...
  <p class="CDB-Text CDB-Size-medium u-altTextColor"><%- _t('components.modals.add-layer.datasets.error.desc') %> <a class="js-mail-link" href="mailto:support@agroviz.com">support@agroviz.com</a>.</p>
</div>
